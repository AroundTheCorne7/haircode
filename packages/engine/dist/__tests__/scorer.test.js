...
describe("computeModuleScores", () => {
    it("returns numeric scores for all modules", () => {
        const scores = computeModuleScores(HEALTHY_PROFILE, NORMALIZERS, WEIGHTS);
...
describe("computeCompositeScore", () => {
    ...
    it("healthy profile scores higher than damaged profile", () => {
        const healthyScores = computeModuleScores(HEALTHY_PROFILE, NORMALIZERS, WEIGHTS);
        const damagedScores = computeModuleScores(DAMAGED_PROFILE, NORMALIZERS, WEIGHTS);
