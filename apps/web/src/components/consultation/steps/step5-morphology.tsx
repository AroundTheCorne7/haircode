      ...
      <div className="border-2 border-dashed border-gray-200 rounded-xl p-4 sm:p-6 text-center">
        {scanned ? (
          <>
            ...
            <p className="text-xs text-gray-400 mb-2">Fields auto-filled — adjust below if needed</p>
          </>
        ) : (
          <>
            ...
            <p className="text-xs text-gray-400 mt-1">Auto-detects shape · undertone · contrast</p>
          </>
        )}
        <button
          type="button"
        ...
        <p className="text-xs text-gray-400 mt-2">Processed on-device only · not stored or transmitted.</p>
      </div>
